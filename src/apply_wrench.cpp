...
Eigen::Vector3d payload_pose_v;
Eigen::Vector3d payload_vel_v;
...
if(model_states.name.size()>0){
   ...
   dv1= con_1_vel - iris_1_vel;
    ...
    ROS_INFO("drone vel x = %f", iris_1_vel(0));
...
//        apply_wrench_payload1.request.wrench.force.x = f1(0)  *factor_2 ;
//        apply_wrench_payload1.request.wrench.force.y =f1(1) *factor_2 ;
//        apply_wrench_payload1.request.wrench.force.z = f1(2)*factor_2 + (2-f1(2)*factor_2) ;

//        apply_wrench_payload2.request.wrench.force.x = f2(0)*factor_2 ;
//        apply_wrench_payload2.request.wrench.force.y =f2(1)*factor_2 ;
//        apply_wrench_payload2.request.wrench.force.z = f2(2)*factor_2 + (2-f2(2)*factor_2);
...
int main(int argc, char **argv)
{
  ...
  ros::Publisher force_on_drone_pub = nh.advertise<geometry_msgs::Point>("/sim_force_on_drone", 2);
 ...
 while (ros::ok())
  {
    ...
    force_on_drone_pub.publish(force_on_drone);
    ros::spinOnce();
    loop_rate.sleep();
  }
